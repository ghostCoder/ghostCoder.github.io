...
// MS Authentication constants

export const MS_TENANT_ID = "52bc7e22-6631-4c88-9c4f-9c115c186148";
export const MS_REFRESH_URL = `https://login.microsoftonline.com/${MS_TENANT_ID}/oauth2/v2.0/token`;
export const MS_ACCESS_TOKEN_URL = MS_REFRESH_URL;
export const MS_AUTH_CODE_SCOPE =
  "ChatMember.Read GroupMember.Read.All User.Read User.ReadBasic.All profile openid email offline_access";
export const MS_AUTH_CODE_URL = `https://login.microsoftonline.com/${MS_TENANT_ID}/oauth2/v2.0/authorize`;

// MS Graph API Endpoints

export const GRAPH_GROUP_MEMBERS = `https://graph.microsoft.com/v1.0/groups`;
export const GRAPH_CHAT_MEMBERS = `https://graph.microsoft.com/beta/chats`;
